...
assert.equal(catalogLessonForBuiltin("N3", 12), 62);
assert.equal(catalogLessonForBuiltin("N3", 13), null);
...
assert.equal(builtinSlotFromCatalog(62)?.jlpt, "N3");
assert.equal(builtinSlotFromCatalog(65), null);
